...
- (void)commonInit {
    ...
    self.font = [UIFont fontWithName:@"STHeitiSC-Light" size:12];
...
- (void)drawRect:(CGRect)rect {    
    ...
    if (self.selectedSegmentIndex != HMSegmentedControlNoSegment && !self.selectionIndicatorStripLayer.superlayer && self.sectionTitles) {
