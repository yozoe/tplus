...
- (void)loadImage:(NSString*)url placeHolder:(UIImage *)placeHolderImage
{
    ...
    [self setImageWithURL:URL placeholderImage:placeHolderImage options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {
        if (expectedSize > 0) {
